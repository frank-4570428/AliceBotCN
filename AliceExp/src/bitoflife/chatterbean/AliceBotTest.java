...
public class AliceBotTest extends TestCase
{
  ...
  */
  ...
  {
    assertEquals("Nice to meet you, . :-)", bot.respond("My name is ."));
    assertEquals("", (String) bot.getContext().property("predicate.name"));
    assertEquals("Thank you, .", bot.respond("Nice to meet you, too."));
